...
export function InlineCell({
    ...
    return (
        <Input
            ...
            className={cn(
                'h-7 w-full min-w-0 rounded-md border border-border bg-bg-card px-1 text-14-medium md:text-14-medium tabular-nums shadow-xs hover:border-ring focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring/30',
