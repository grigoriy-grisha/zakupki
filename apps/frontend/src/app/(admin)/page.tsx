        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
                <Card rounded="2xl" className="gap-3 p-5">
                    ...
                    <p className="font-display text-36-semibold tabular-nums text-fg-primary">{activeCount}</p>
                ...
                <Card rounded="2xl" className="gap-3 p-5">
                    ...
                    <p className="font-display text-36-semibold tabular-nums text-fg-primary">{productCount}</p>
                    <Button variant="link" className="h-auto p-0 text-14-medium text-secondary" asChild>
